...
<div style="padding:100px; " align="center" dir=rtl>
  ...
  <tr style="background:gray; color:#fff;" >
    ...
    <td style="padding:10px; font-size: 15px;" width="100px" >approve</td>
    <td style="padding:10px; font-size: 15px;" width="100px" >cancel</td>
    ...
    <trذ align="center" width="auto" height="auto">
      ...
      <td style="padding:10px; font-size: 15px;">{{$users->address}}</td>
           ...
           <td style="padding:10px; font-size: 15px;" class="status-{{$users->status}}">{{$users->status}} </td>
            ...
            <a href="{{url('cancel',$users->id)}}" onclick="return confirm('هل أنت متأكد من قبول هذا الطلب؟')" class="btn btn-danger">  الغاء</a>
